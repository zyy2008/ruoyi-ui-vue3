...
import "@mars/components/mars-ui/base.scss"
import { injectState, key } from "@mars/widgets/common/store/widget"
import store_mars from "@mars/widgets/widget-store"
import MarsUIInstall from "@mars/components/mars-ui"
app.use(injectState(store_mars), key) //初始化火星弹框
MarsUIInstall(app, {
  dialog: {
    position: {
      left: 50,
...
import '@/assets/styles/mapUI.scss' // global css
