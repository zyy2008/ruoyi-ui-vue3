...
export async function putAdminGroundwaterMonitoring(
  ...
  return request<Record<string, any>>(`/api1/admin/groundwaterMonitoring`, {
    method: "PUT",
    headers: {
...
export async function deleteAdminGroundwaterMonitoringIds(
  ...
  return request<Record<string, any>>(
    `/api1/admin/groundwaterMonitoring/${param0}`,
    {
      method: "DELETE",
      params: { ...queryParams },
      ...(options || {}),
...
export async function postAdminGroundwaterMonitoringExport(
  ...
  return request<any>(`/api1/admin/groundwaterMonitoring/export`, {
    method: "POST",
    params: {
      ...params,
      params: undefined,
...
export async function getAdminGroundwaterMonitoringList(
  ...
  return request<API.TableDataInfo>(`/api1/admin/groundwaterMonitoring/list`, {
    method: "GET",
    params: {
      ...params,
      params: undefined,
