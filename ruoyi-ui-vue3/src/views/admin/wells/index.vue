    ...
    >
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="水位埋深">{{
          detailForm.waterBuriedDepth
        }}</el-descriptions-item>
        <el-descriptions-item label="井口高程">{{
          detailForm.wellElevation
        }}</el-descriptions-item>
        <el-descriptions-item label="成井深度">{{
          detailForm.wellDepth
        }}</el-descriptions-item>
        ...
        <el-descriptions-item label="结构">{{
          detailForm.multiScreenPipe
        }}</el-descriptions-item>
        <el-descriptions-item label="埋深范围">{{
          detailForm.screenDepthRange
        }}</el-descriptions-item>
        <el-descriptions-item label="地下水类型">{{
          detailForm.groundwaterType
        }}</el-descriptions-item>
        <el-descriptions-item label="埋藏条件">{{
          detailForm.burialCondition
        }}</el-descriptions-item>
        <el-descriptions-item label="含水介质">{{
          detailForm.waterMedium
        }}</el-descriptions-item>
        <el-descriptions-item label="权属单位">{{
          detailForm.ownership
        }}</el-descriptions-item>
        <el-descriptions-item label="是否符合标准">{{
          detailForm.suitableForLongterm
        }}</el-descriptions-item>
...
function handleDelete(row) {
  ...
  proxy.$modal
    .confirm(
      '是否确认删除园区初调监测井信息，记录每个监测井的基础属性与附加信息编号为"' +
        _ids +
        '"的数据项？'
    )
    .then(function () {
