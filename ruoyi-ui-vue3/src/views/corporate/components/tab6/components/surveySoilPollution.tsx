  ...
  defineComponent({
    setup() {
      ...
      const { data, run } = useRequest(() =>
        API.getAdminSurveyGroundwaterPollutionList({
          deptId,
        })
      );
      watchEffect(() => {
      ...
      provide("form", {
        run,
        apiAdd: API.postAdminSurveyGroundwaterPollution,
        apiEdit: API.putAdminSurveyGroundwaterPollution,
        apiDel: API.deleteAdminSurveyGroundwaterPollutionIds,
      });
      return () => (
