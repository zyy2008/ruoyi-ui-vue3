<template>
  <el-dialog
    ...
    :title="
      chart.chartType === 'monitor'
        ? chart.chartTitle.monitoringWell + '(' + chart.chartTitle.location + ')'
        : chart.chartTitle.wellCode + '(' + chart.chartTitle.location + ')'
    "
    width="100vw"
    :top="'200px'"
    destroy-on-close
    @open="openChartLine"
    @close="closeChartLine"
    style="height: 900px"
  >
    <el-date-picker
      v-model="timeValue"
    ...
    <el-button type="primary" color="#072d50" :icon="Search" style="margin-left: 20px"
      >查询</el-button
    >
    <el-select
      v-model="selectValue"
    ...
    >
      <el-option
        v-for="item in chart.chartType === 'monitor' ? options1 : indicatorsOption"
        :key="item.value"
        :label="item.label"
        :value="item.value"
      >
    ...
    <el-table
      ...
      style="width: 100%"
      max-height="350"
      v-show="chart.chartType === 'monitor'"
    >
    ...
    >
      ...
      <el-table-column
        prop="tetrachloroethane1122"
        label="1,1,2,2-四氯乙烷(μg/L)"
        width="170"
      />
      ...
      <el-table-column
        prop="trichloroethane111"
        label="1,1,1-三氯乙烷(μg/L)"
        width="120"
      />
      <el-table-column
        prop="trichloroethane112"
        label="1,1,2-三氯乙烷(μg/L)"
        width="120"
      />
      ...
      <el-table-column
        ...
        label="反式-1,2-二氯乙烯(μg/L)"
        width="140"
      />

      <el-table-column
        prop="cisDichloroethylene12"
        label="顺式-1,2-二氯乙烯(μg/L)"
        width="140"
      />
      ...
      <el-table-column
        prop="petroleumHydrocarbonsC6C9"
        label="石油烃(C6-C9)(mg/L)"
        width="120"
      />
      <el-table-column
        prop="petroleumHydrocarbonsC10C40"
        label="石油烃(C10-C40)(mg/L)"
        width="140"
      />
      ...
      <el-table-column
        prop="indeno123cdPyrene"
        label="茚并[1,2,3-c,d]芘(μg/L)"
        width="140"
      />

      <el-table-column
        prop="dibenzoAhAnthracene"
        label="二苯并[a,h]蒽(μg/L)"
        width="110"
      />
      ...
      <el-table-column
        prop="tetrachloroethane1112"
        label="1,1,1,2-四氯乙烷(μg/L)"
        width="130"
      />
      <el-table-column
        prop="tetrachloroethane1122"
      ...
      <el-table-column
        prop="trichloropropane123"
        label="1,2,3-三氯丙烷(μg/L)"
        width="130"
      />
      <el-table-column prop="bromochloromethane" label="溴氯甲烷(μg/L)" width="130" />
      <el-table-column
        prop="bromodichloromethane"
        label="一溴二氯甲烷(μg/L)"
        width="130"
      />
      ...
      <el-table-column
        prop="trimethylbenzene135"
        label="1,3,5-三甲基苯(μg/L)"
        width="130"
      />
      ...
      <el-table-column
        prop="trimethylbenzene124"
        label="1,2,4-三甲基苯(μg/L)"
        width="130"
      />
      ...
      <el-table-column
        prop="dibromo3Chloropropane12"
        label="1,2-二溴-3-氯丙烷(μg/L)"
        width="130"
      />
      <el-table-column
        prop="trichlorobenzene124"
        label="1,2,4-三氯苯(μg/L)"
        width="130"
      />
      ...
      <el-table-column
        prop="trans13Dichloropropene"
        label="反式-1,3-二氯丙烯(μg/L)"
        width="130"
      />
      <el-table-column
        prop="trans13Dichloropropene"
        label="反-1,3-二氯丙烯(μg/L)"
        width="130"
      />
      <el-table-column
        prop="cis13Dichloropropene"
        label="顺式-1,3-二氯丙烯(μg/L)"
        width="130"
      />

      <el-table-column
        prop="cis13Dichloropropene"
        label="顺-1,3-二氯丙烯(μg/L)"
        width="130"
      />
      ...
      <el-table-column
        prop="trichlorobenzene123"
        label="1,2,3-三氯苯(μg/L)"
        width="150"
      />
    </el-table>
  </el-dialog>
...
function changeSelect(label) {
  let data = [];
  let time = tableData.value.map((ele) =>
    chart.chartType === "monitor" ? ele.monitoringTime : ele.sampleTime
  );
