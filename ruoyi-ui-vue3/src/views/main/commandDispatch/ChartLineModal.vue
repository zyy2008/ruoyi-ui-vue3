<template>
  <el-dialog
    ...
    :title="chart.chart.chartInfo.wellCode"
    width="100vw"
    :top="'200px'"
    destroy-on-close
    @open="openChartLine"
  >
    ...
    >
      ...
      <el-table-column prop="anionicSurfactant" label="阴离子表面活性剂" />
      ...
      <el-table-column prop="nitriteNitrogen" label="亚硝酸盐氮" />
      ...
      <el-table-column prop="dichloroethane12" label="1,2-二氯乙烷" />
      <el-table-column prop="trichloroethane111" label="1,1,1-三氯乙烷" />
      <el-table-column prop="trichloroethane112" label="1,1,2-三氯乙烷" />
      <el-table-column prop="dichloropropane12" label="1,2-二氯丙烷" />
      <el-table-column prop="vinylChloride" label="氯乙烯" />
      <el-table-column prop="dichloroethylene11" label="1,1-二氯乙烯" />
      <el-table-column
        prop="transDichloroethylene12"
        label="反式-1,2-二氯乙烯"
      />
      <el-table-column prop="cisDichloroethylene12" label="顺式-1,2-二氯乙烯" />
      ...
      <el-table-column prop="dichlorobenzene12" label="1,2-二氯苯" />
      <el-table-column prop="dichlorobenzene14" label="1,4-二氯苯" />
      <el-table-column prop="ethylbenzene" label="乙苯" />
      <el-table-column prop="xyleneOrtho" label="邻二甲苯" />
      <el-table-column prop="xyleneMetaPara" label="间/对-二甲苯" />
      ...
      <el-table-column prop="benzoBFluoranthene" label="苯并[b]荧蒽" />
      <el-table-column prop="benzoAPyrene" label="苯并[a]芘" />
      <el-table-column prop="petroleumHydrocarbonsC6C9" label="石油烃(C6-C9)" />
      <el-table-column
        prop="petroleumHydrocarbonsC10C40"
        label="石油烃(C10-C40)"
      />
      ...
      <el-table-column prop="benzoAAnthracene" label="苯并[a]蒽" />
      <el-table-column prop="chrysene" label="䓛" />
      <el-table-column prop="benzoKFluoranthene" label="苯并[k]荧蒽" />
      <el-table-column prop="indeno123cdPyrene" label="茚并[1,2,3-c,d]芘" />
      <el-table-column prop="dibenzoAhAnthracene" label="二苯并[a,h]蒽" />
      <el-table-column prop="benzoGhiPerylene" label="苯并[g,h,i]苝" />
      <el-table-column prop="chloromethane" label="氯甲烷" />
      <el-table-column prop="dichloroethane11" label="1,1-二氯乙烷" />
      <el-table-column prop="tetrachloroethane1112" label="1,1,1,2-四氯乙烷" />
      <el-table-column prop="tetrachloroethane1122" label="1,1,2,2-四氯乙烷" />
      <el-table-column prop="trichloropropane123" label="1,2,3-三氯丙烷" />
    </el-table>
  </el-dialog>
</template>
<script setup>
